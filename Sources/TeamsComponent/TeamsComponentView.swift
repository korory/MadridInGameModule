...
extension TeamsComponentView {
    private var titleBanner: some View {
        HStack {
            Text(viewModel.isUserMode ? "dashboard.profile.teams.title".localized: "dashboard.teams.team".localized)
                .font(.title)
                .fontWeight(.bold)
            ...
            if viewModel.isUserMode {
                Button {
                    ...
                    HStack {
                        Text(viewModel.isUserMode ? "dashboard.profile.teams.createTeam".localized : "dashboard.teams.teamAreas.editTeam.buttonForm".localized)
                            .font(.system(size: 17))
                            .bold()
                            .foregroundStyle(Color.white)
    ...
    private var applyForAdmissionComponent: some View {
        VStack (spacing: 40){
            CustomButton(text: "dashboard.profile.teams.requestTeam".localized,
            ...
            CustomButton(text: "dashboard.profile.teams.noInvitations".localized,
